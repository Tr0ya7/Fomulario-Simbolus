                ...
                <div class="pagina">
                      <div class="opcoes">
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_1_1" value="1" id="pro1" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro1" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_1_1" value="0" id="N1" onclick="hideElements('N1'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_1" id="secondCheckboxContainer1" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_1_2" value="1" id="que_1">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_1_2" value="0" id="que_2">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_1_3" value="1" id="que_1">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_1_3" value="0" id="que_1">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                              ...
                              <div id="caixa-texto-pro1" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_1_texto" placeholder="." id="floatingTextarea1" style="height: 100px; width: 850px;"></textarea>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_2_1" value="1" id="pro2" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro2" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_2_1" value="0" id="N2" onclick="hideElements('N2'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_2" id="secondCheckboxContainer2" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_2_2" value="1" id="que_2">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_2_2" value="0" id="que_2">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                              ...
                              <div id="caixa-texto-pro2" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_2_texto" placeholder="." id="floatingTextarea2" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_3_1" value="1" id="pro3" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro3" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_3_1" value="0" id="N3" onclick="hideElements('N3'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_3" id="secondCheckboxContainer3" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_3_2" value="1" id="que_3">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_3_2" value="0" id="que_3">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_3_3" value="1" id="que_3">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_3_3" value="0" id="que_3">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                              ...
                              <div id="caixa-texto-pro3" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_3_texto" placeholder="." id="floatingTextarea3" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_4_1" value="1" id="pro4" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro4" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_4_1" value="0" id="N4" onclick="hideElements('N4'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_4" id="secondCheckboxContainer4" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_4_2" value="1" id="que_4">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                              ...
                              <div id="caixa-texto-pro4" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_4_texto" placeholder="." id="floatingTextarea4" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_5_1" value="1" id="pro5" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro5" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_5_1" value="0" id="N5" onclick="hideElements('N5'); limparCampos()">
                              ...
                              <div id="caixa-texto-pro5" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_5_natureza" placeholder="." id="natureza5" style="height: 20px; width: 850px;"></textarea>
                              ...
                              <div class="secondCheckboxContainer_5" id="secondCheckboxContainer5" style="display: none;">
                                ...
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_5_parte" value="0" id="secondCheckbox1">
                                  <label class="form-check-label" for="secondCheckbox1">
                                    Réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_5_parte" value="1" id="que_5">
                                  <label class="form-check-label" for="secondCheckbox2" id="testemunha_reu">
                                    Testemunha do réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_5_parte" value="2" id="secondCheckbox3">
                                  <label class="form-check-label" for="secondCheckbox3">
                                    Testemunha do reclamante
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_5_parte" value="3" id="secondCheckbox4">
                              ...
                              <div class="form-check" id="form-check1">
                                  <input class="form-check-input" type="radio" name="que_5_aberto" value="1" id="que_5">
                                  <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                      Sim
                                  </label>
                                  <div class="checkbox1">
                                      <input class="form-check-input" type="radio" name="que_5_aberto" value="0" id="que_5">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                          Não
                                      </label><br>
                                  </div>
                              ...
                              <div id="caixa-texto-pro5_1" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_5_texto" placeholder="." id="floatingTextarea5" style="height: 100px; width: 850px;"></textarea>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_6_1" value="1" id="pro6" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro5" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_6_1" value="0" id="N6" onclick="hideElements('N6'); limparCampos()">
                              ...
                              <div id="caixa-texto-pro6" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_6_natureza"  placeholder="." id="natureza6" style="height: 20px; width: 850px;"></textarea>
                              ...
                              <div class="secondCheckboxContainer_6" id="secondCheckboxContainer6" style="display: none;">
                                <h5 style="margin: 20px 0 5px 0;">Você é qual das partes?</h5>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_6_parte" value="0" id="secondCheckbox1">
                                  <label class="form-check-label" for="secondCheckbox1">
                                    Réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_6_parte" value="1" id="que_6">
                                  <label class="form-check-label" for="secondCheckbox2" id="testemunha_reu">
                                    Testemunha do réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_6_parte" value="2" id="secondCheckbox3">
                                  <label class="form-check-label" for="secondCheckbox3">
                                    Testemunha do reclamante
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_6_parte" value="3" id="secondCheckbox4">
                                  <label class="form-check-label" for="secondCheckbox4">
                                    Reclamante
                                  </label><br>
                                </div>
                              ...
                              <div class="form-check" id="form-check1">
                                  <input class="form-check-input" type="radio" name="que_6_aberto" value="1" id="que_6">
                                  <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                      Sim
                                  </label>
                                  <div class="checkbox1">
                                      <input class="form-check-input" type="radio" name="que_6_aberto" value="0" id="que_6">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                          Não
                                      </label><br>
                                  </div>
                              ...
                              <div id="caixa-texto-pro6_1" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_6_texto" id="floatingTextarea6" placeholder="." style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea2">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_7_1" value="1" id="pro7" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro7" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_7_1" value="0" id="N7" onclick="hideElements('N7'); limparCampos()">
                              ...
                              <div id="caixa-texto-pro7" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_7_natureza" placeholder="." id="natureza7" style="height: 20px; width: 850px;"></textarea>
                              ...
                              <div class="secondCheckboxContainer_7" id="secondCheckboxContainer7" style="display: none;">
                                <h5 style="margin: 20px 0 5px 0;">Você é qual das partes?</h5>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_7_parte" value="0" id="secondCheckbox1">
                                  <label class="form-check-label" for="secondCheckbox1">
                                    Réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_7_parte" value="1" id="que_7">
                                  <label class="form-check-label" for="secondCheckbox2" id="testemunha_reu">
                                    Testemunha do réu
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_7_parte" value="2" id="secondCheckbox3">
                                  <label class="form-check-label" for="secondCheckbox3">
                                    Testemunha do reclamante
                                  </label><br>
                                </div>
                                <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="que_7_parte" value="3" id="secondCheckbox4">
                                  <label class="form-check-label" for="secondCheckbox4">
                                    Reclamante
                                  </label><br>
                                </div>
                              ...
                              <div class="form-check" id="form-check1">
                                  <input class="form-check-input" type="radio" name="que_7_aberto" value="1" id="que_7">
                                  <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                      Sim
                                  </label>
                                  <div class="checkbox1">
                                      <input class="form-check-input" type="radio" name="que_7_aberto" value="0" id="que_7">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                          Não
                                      </label><br>
                                  </div>
                              ...
                              <div id="caixa-texto-pro7_1" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_7_texto" id="floatingTextarea7" placeholder="." style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea2">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_8_1" value="1" id="pro8" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro8" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_8_1" value="0" id="N8" onclick="hideElements('N8'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_8" id="secondCheckboxContainer8" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_8_2" value="1" id="que_8">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_8_2" value="0" id="que_8">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_8_3" value="1" id="que_8">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_8_3" value="0" id="que_8">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                              ...
                              <div id="caixa-texto-pro8" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_8_texto" id="floatingTextarea8" placeholder="." style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_9_1" value="1" id="pro9" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro9" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_9_1" value="0" id="N9" onclick="hideElements('N9'); limparCampos()">
                              ...
                              <div class="secondCheckboxContainer_9" id="secondCheckboxContainer9" style="display: none;">
                                  ...
                                  <div class="form-check" id="form-check1">
                                      <input class="form-check-input" type="radio" name="que_9_2" value="1" id="que_9">
                                      <label id="form-check-label2" class="form-check-label" for="secondCheckbox">
                                          Sim
                                      </label>
                                      <div class="checkbox1">
                                          <input class="form-check-input" type="radio" name="que_9_2" value="0" id="que_9">
                                          <label id="form-check-label2" class="form-check-label" for="secondCheckbox2">
                                              Não
                                          </label><br>
                                      </div>
                              ...
                              <div id="caixa-texto-pro9" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_9_texto" placeholder="." id="floatingTextarea9" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_10_1" value="1" id="pro10" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro10" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_10_1" value="0" id="N10" onclick="hideElements('N10'); limparCampos()">
                              ...
                              <div id="caixa-texto-pro10" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_10_texto" placeholder="." id="floatingTextarea10" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-check">
                              <input class="form-check-input" type="radio" name="que_11_1" value="1" id="pro11" onclick="showSecondCheckbox()" onchange="showHideTextBox()">
                              <label class="form-check-label" for="pro11" id="Sim">
                                  Sim
                              </label>
                              <div class="Nao">
                                  <input class="form-check-input" type="radio" name="que_11_1" value="0" id="N11" onclick="hideElements('N11'); limparCampos()">
                              ...
                              <div id="caixa-texto-pro11" class="hidden">
                                <div class="form-floating">
                                  <textarea class="form-control" type="text" name="que_11_texto" placeholder="." id="floatingTextarea11" style="height: 100px; width: 850px;"></textarea>
                                  <label for="floatingTextarea1">Comente sobre</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-floating">
                              <textarea class="form-control" type="text" name="que_12_texto" placeholder="." id="floatingTextarea12" style="height: 100px; width: 850px;"></textarea>
                              <label for="floatingTextarea2">Comente sobre</label>
                          </div>
                      </div>
            </div>
