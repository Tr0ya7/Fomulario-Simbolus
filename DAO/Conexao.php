...
class Conexao {
    ...
    private $database = "189.16.105.34/3050:C:\SIMBOLUS\BANCO\banco.GDB";
    //private $database = "localhost/3070:C:\BANCOS\ABG\banco.fdb";
    private $conexao = null;

    public function __construct() {
        if ($this->conexao == null)
        {
            $this->conexao = ibase_connect($this->database, 'SYSDBA', 'z352759Z$#@','WIN1252', null, 1);
